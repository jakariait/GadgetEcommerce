...
const HeaderSearch = () => {
  ...
  return (
    <div className="flex-1 max-w-md  hidden lg:flex relative items-center">
      <input
        type="text"
        ...
        className="px-3 py-2 w-full rounded-full outline-none text-white border border-gray-200  pr-10"
      />
      <button
