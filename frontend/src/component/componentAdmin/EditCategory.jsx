...
const EditCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("featureCategory", category?.featureCategory);
    formData.append("showOnNavbar", category?.showOnNavbar);
    if (categoryImage) {
                ...
                <Select
                  ...
                  onChange={
                    (e) =>
                      setCategory({
                        ...category,
                        featureCategory: e.target.value === "true",
                ...
                <Select
                  ...
                  onChange={
                    (e) =>
                      setCategory({
                        ...category,
                        showOnNavbar: e.target.value === "true",
                      }) // Convert back to boolean
                  }
